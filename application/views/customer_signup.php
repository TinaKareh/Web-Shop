...
<div class="container my-5">
  ...
  <h4 class="card-title font-italic text-primary" style="padding-left: 450px !important;">Register</h4>
    <div class="card-body">
  ...
  <br/>
   <div class ="div-custom" align ="right" style="padding: 20px !important;">
      <label class="control-label col-sm-13" for="signup">Already have an account?</label>
         <a href="<?= base_url('sign-in'); ?>"><span class="glyphicon glyphicon-log-in"></span> Login</a><br/>
	</div>
    </div>
  </div>
</div>
